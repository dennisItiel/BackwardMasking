function H=shadedErrorBar(x,y,errBar,lineProps,transparent,axs)
...
edgeColor=col+(1-col)*1; %change the colore of the edge of errorbar
...
%H.edge(1)=plot(x,lE,'-','color',edgeColor);   %add edge to the overlaped patch
%H.edge(2)=plot(x,uE,'-','color',edgeColor);   %add edge to the overlaped patch
